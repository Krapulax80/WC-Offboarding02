...
# ## OFFBOARDING PROCESS - PHASE1
#     Write-Host -BackgroundColor Black "PHASE1 PROCESS STARTED."
# # Run on all files...
...
#       $global:ForwardingAddress = $null
#       If ($Line.ForwardingAddress -like "*$Domain*"){
#       $global:ForwardingAddress = $Line.ForwardingAddress
#       #Write-Host -fore Magenta "We will forward to [$ForwardingAddress]"
#       }

#       # Execute against each lines
#         if ($Domain -match "WestCoast"){
#           # REPORT
#           Add-Member -InputObject $Line -NotePropertyName "DOM" -NotePropertyValue "Yes"
#           # WORK
#           $timer = (Get-Date -Format yyy-MM-dd-HH:mm);	Write-Host "[$timer] - WESTCOAST OFFBOARDING OF [$FirstName $Lastname]" -ForegroundColor Green
#           Process-OffBoarding01 -westcoast -FirstName $FirstName -LastName $LastName -EmployeeID $EmployeeID -ForwardingAddress $ForwardingAddress
#         }
#         elseif ($Domain -match "XMA"){
#           # REPORT
#           Add-Member -InputObject $Line -NotePropertyName "DOM" -NotePropertyValue "Yes"
#           # WORK
#           $timer = (Get-Date -Format yyy-MM-dd-HH:mm);	Write-Host "[$timer] - XMA OFFBOARDING OF [$FirstName $Lastname]" -ForegroundColor Green
#           Process-OffBoarding01 -xma -FirstName $FirstName -LastName $LastName -EmployeeID $EmployeeID -ForwardingAddress $ForwardingAddress
#         }
#         else {
#           # REPORT
#           Add-Member -InputObject $Line -NotePropertyName "DOM" -NotePropertyValue "No"
#           Add-Member -InputObject $Line -NotePropertyName "UFound" -NotePropertyValue "n/a"
#           # WORK
#           $timer = (Get-Date -Format yyy-MM-dd-HH:mm);	Write-Host "[$timer] - [$domain] IS INVALID DOMAIN - Offboarding cancelled for [$FirstName $Lastname]" -ForegroundColor Red
#         }
#     }
...
# # Discard the processed original input file
# Remove-Item -Path $($I.Fullname) -Force -Whatif
# }

## OFFBOARDING PROCESS - PHASE2
Write-Host -BackgroundColor Black "PHASE2 PROCESS STARTED"
#FIXME: Rework this process

#Create the report CSV

  #Execute second part of the offboarding
  Process-OffBoarding02 -WestCoast
  Process-OffBoarding02 -XMA

# SIG # Begin signature block
# MIIOWAYJKoZIhvcNAQcCoIIOSTCCDkUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU5f6+JqSkRGq7SnVBIyTDFE87
# ULWgggueMIIEnjCCA4agAwIBAgITTwAAAAb2JFytK6ojaAABAAAABjANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUNC09Pma/CNRfTr5kNDDvfGEvu0cwDQYJKoZI
# hvcNAQEBBQAEggEAzfxJLEnDURuwtB4Hxwne4QIq4VuxepO7Rfz/+6Mkv7AZpC6T
# arWnGyTR5J8QXyN6T26PRyOG+/Xl7VFAZ8i3FEUUdA4+h9AZv6ukXdtkdrKFyd4+
# VCSX1kLkqDcBe/hE9gxcNgFWlcNjXvZGksj3UkvTmFWjdrimVicrcUixQfbdUwUa
# DJZR1d9bmD/TMh8xm9fC5qGtb1Wbi+N5J3i4bUTMXJ4//wMibTFc3WcPx5irnx6V
# WHm2VjNaGGdp/vv4MVXGBOP28VHBEDL8byPUvgdIhP+2dWbCoTfGlWZXp1sy9ovg
# dCt3Z7ZfsGSVXJOx57a2VTQeLxqjugZFQhp29A==
